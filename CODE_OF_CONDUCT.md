...
1. **GitHub Issues**: Create a private security issue
2. **Direct Contact**: Contact the maintainers directly via email
3. **External Resources**: Use Contributor Covenant's reporting resources
